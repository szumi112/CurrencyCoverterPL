...
var App = function () {
    ...
    return (React.createElement("div", { className: "App" },
        React.createElement("h1", { className: 'bold' }, "Kalkulator Walutowy"),
        React.createElement("div", { className: "convertRow" },
            React.createElement("div", null,
                React.createElement("p", { className: 'bold' }, " Przelicz z"),
            ...
            React.createElement("div", null,
                React.createElement("p", { className: 'bold' }, "Przelicz na"),
            ...
            React.createElement("div", { className: 'kwota' },
                React.createElement("p", { className: 'bold' }, "Kwota"),
                React.createElement("input", { type: "number", className: 'inputOne', placeholder: 'wpisz kwot\u0119', onChange: function (e) { return setFromTo(e.target.value); }, onKeyPress: function (ev) {
                        if (ev.key === "Enter") {
            ...
            React.createElement("div", { className: 'wynik' },
                React.createElement("p", { className: 'bold' }, "Wynik"),
        ...
        React.createElement("div", { className: 'btns' },
            React.createElement("button", { className: 'historiaBtn', onClick: function () { return setShowHistory(!showHistory); } }, " Historia "),
            React.createElement("button", { className: 'konwertujBtn', onClick: handleAddToHistory }, " Konwertuj ")),
        showHistory && ((_a = history[1]) === null || _a === void 0 ? void 0 : _a.data) !== undefined ? (React.createElement(React.Fragment, null,
            React.createElement("div", { className: 'hist' },
                React.createElement("p", { className: 'bold data' }, "Data"),
                React.createElement("p", { className: 'bold przed' }, "Przed konwersj\u0105"),
                React.createElement("p", { className: 'bold po' }, "Po konwersji")),
